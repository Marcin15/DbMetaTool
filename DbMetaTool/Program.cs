using DbMetaTool.UseCases.BuildDatabase;
using DbMetaTool.UseCases.ExportDatabase;
using DbMetaTool.UseCases.UpdateDatabase;
...
public static class Program
{
    ...
    public static void BuildDatabase(string databaseDirectory, string scriptsDirectory)
    {
        ...
        ///
        BuildDatabaseUseCase.Invoke(databaseDirectory, scriptsDirectory);
    }
    ...
    public static void ExportScripts(string connectionString, string outputDirectory)
    {
        ...
        ExportDatabaseUseCase.Invoke(connectionString, outputDirectory);
    }
    ...
    public static void UpdateDatabase(string connectionString, string scriptsDirectory)
    {
        ...
        UpdateDatabaseUseCase.Invoke(connectionString, scriptsDirectory);
    }
}
